      ...
      <div className="container mx-auto px-4">
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-primary-foreground mb-2">
            Thanks for Rocking with ContentFlow!
          </h3>
          <p className="text-sm max-w-2xl mx-auto">
            We’re here for the wins, the fails, and everything in between.
          </p>
        </div>
        ...
        <div className="mb-6 p-6 bg-card/50 rounded-lg border border-accent/20 shadow-md">
          <h4 className="text-lg font-semibold text-accent mb-3 flex items-center justify-center">
            ...
            Blow Up on ShareSpace
          </h4>
          <p className="text-sm mb-4 max-w-xl mx-auto">
            Share your content on the <Link href="/feed" className="text-accent hover:underline font-medium">ShareSpace</Link> to showcase your work, connect with other creators, and gain inspiration. The more you share, the more visibility you get!
          </p>
        ...
        <p className="text-xs">
          &copy; {new Date().getFullYear()} ContentFlow.Powered by creators. Idea by Techez😊
        </p>
      </div>
    </footer>
  );
